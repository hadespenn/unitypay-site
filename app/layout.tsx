  ...
  return (
    <html lang="en">
      <head>
        ...
        {/* Preload full CSS — fetched early but not applied until after first paint */}
        <link rel="preload" href="/css/full.css" as="style" />
        {/* Noscript fallback: load full CSS directly for users without JS */}
        <noscript>
      ...
      <body className={`${manrope.variable} ${notoSansSC.variable}`}>
        {/* Load full CSS after first paint — non-render-blocking via media="print" pattern */}
        <DeferredStyles href="/css/full.css" />
